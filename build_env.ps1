...
$buildJob = Start-Job -ScriptBlock {
    Start-Process "dotnet" -ArgumentList "build", "BlazorApp.csproj", "-c", "Development" -NoNewWindow
}
...
$publishJob = Start-Job -ScriptBlock {
    Start-Process "dotnet" -ArgumentList "publish", "BlazorApp.csproj", "-c", "Development" -NoNewWindow
}
